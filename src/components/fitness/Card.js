...
export default function Card() {
 ...
 <Link to="/" className="btn cardbtn">
  <img src={Images.f1} alt="Card 1" style={{width:"100%"}}/>

    <div className="card-body">
      <h4 className="card-title">iXXi Jean</h4>
 ...
 <Link to="/" className="btn cardbtn">
  ...
  <img src={Images.f4} alt="Card 2" style={{width:"100%"}}/>

    <div className="card-body">
    <h4 className="card-title">iXXi Black Tight</h4>
