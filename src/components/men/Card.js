...
export default function Card() {
 ...
 <Link to="/reuse" className="btn cardbtn">
  <img src={Images.m3} alt="Card 1" style={{width:"100%"}}/>

    <div className="card-body">
      <h4 className="card-title">iXXi Cover All</h4>
 ...
 <Link to="/reuse" className="btn cardbtn">
  ...
  <img src={Images.m9} alt="Card 2" style={{width:"100%"}}/>

    <div className="card-body">
    <h4 className="card-title">iXXi glasses & Shirts</h4>
